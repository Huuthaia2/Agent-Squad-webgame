...
function boot () {
    var onStart = function () {
        ...
        // load scene
        cc.director.preloadScene(launchScene, null, function() {
            minigame.startGameAsync()
                ...
                .catch(function(error) {
                    console.error("minigame sdk start error: ", error.message);
                })    
        });
...
minigame.initializeAsync()
    ...
    .catch(function(error) {
        console.info("minigame sdk init error: ", error.message);
    });
